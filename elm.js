...
Elm.Main.make = function (_elm) {
      ...
      return function () {
         ...
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v0._1 * t};}
         _U.badCase($moduleName,
         "on line 170, column 22 to 34");
      }();
   });
   var vecLen = function (_v4) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return $Basics.sqrt(_v4._0 * _v4._0 + _v4._1 * _v4._1);}
         _U.badCase($moduleName,
         "on line 167, column 17 to 36");
      }();
   };
   var vecSub = F2(function (_v8,
   _v9) {
      return function () {
         switch (_v9.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v8._1 - _v9._1};}
                 _U.badCase($moduleName,
                 "on line 164, column 27 to 41");
              }();}
         _U.badCase($moduleName,
         "on line 164, column 27 to 41");
      }();
   });
   var vecAdd = F2(function (_v16,
   _v17) {
      return function () {
         switch (_v17.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v16._1 + _v17._1};}
                 _U.badCase($moduleName,
                 "on line 161, column 27 to 41");
              }();}
         _U.badCase($moduleName,
         "on line 161, column 27 to 41");
      }();
   });
   var center = function (_v24) {
      return function () {
         switch (_v24.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: _v24._1 / 2 | 0};}
         _U.badCase($moduleName,
         "on line 158, column 18 to 32");
      }();
   };
   var relativeMouse = F2(function (_v28,
   _v29) {
      return function () {
         switch (_v29.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ,_0: _v29._0 - _v28._0
                           ,_1: 0 - (_v29._1 - _v28._1)};}
                 _U.badCase($moduleName,
                 "on line 155, column 34 to 51");
              }();}
         _U.badCase($moduleName,
         "on line 155, column 34 to 51");
      }();
   });
   var renderText = F3(function (y,
   scl,
   str) {
      return $Graphics$Collage.move({ctor: "_Tuple2"
                                    ,_0: 0
                                    ,_1: y})($Graphics$Collage.scale(scl)($Graphics$Collage.toForm($Text.centered($Text.color($Color.gray)($Text.fromString(str))))));
   });
   var renderScore = function (s) {
      return A3(renderText,
      0,
      4,
      $Basics.toString(s));
   };
   var renderPill = function (_v36) {
      return function () {
         return $Graphics$Collage.move(_v36.pos)($Graphics$Collage.filled(_v36.col)($Graphics$Collage.circle(_v36.rad)));
      }();
   };
   var overlaps = F2(function (player,
   pill) {
      return function () {
         var distance = vecLen(A2(vecSub,
         player.pos,
         pill.pos));
         return _U.cmp(distance,
         player.rad + pill.rad) < 0;
      }();
   });
   var stepPlayer = F2(function (_v38,
   p) {
      return function () {
         switch (_v38.ctor)
         {case "_Tuple2":
            return _U.replace([["pos"
              ...
              p);}
         _U.badCase($moduleName,
         "on line 128, column 27 to 58");
      }();
   });
   var stepPill = F2(function (t,
   p) {
      return _U.replace([["pos"
                         ,vecAdd(p.pos)(A2(vecMultS,
                         p.vel,
                         t))]],
      p);
   });
   ...
   var isVisible = function (_v42) {
      return function () {
         return _U.cmp($Basics.snd(_v42.pos) + _v42.rad,
         0 - hHeight) > 0;
      }();
   };
   var width = 400;
   ...
   var randomPill = function (seed) {
      return function () {
         var probability = A2($Random.$float,
         0,
         1);
         var xRange = A2($Random.$float,
         0 - hWidth,
         hWidth);
   ...
   defaultPill);
   var Over = {ctor: "Over"};
   var stepGamePlay = F2(function (e,
   _v59) {
      return function () {
         return function () {
            switch (e.ctor)
            {case "Click": return _v59;
               case "Input": switch (e._0.ctor)
                 {case "_Tuple2":
                    return function () {
                         ...
                         var g$ = _U.replace([["player"
                                             ...
                                             ,["pills"
                                              ...
                                              untouched)]
                                             ,["score"
                                              ,_v59.score + $List.length(blues)]],
                         _v59);
                         return $List.isEmpty(reds) ? g$ : _U.replace([["state"
                                                                       ,Over]],
                         g$);
                      }();}
                 break;
   ...
   var Spawn = {ctor: "Spawn"};
   var Input = function (a) {
      return {ctor: "Input",_0: a};
   };
   var render = F2(function (_v67,
   g) {
      return function () {
         switch (_v67.ctor)
         {case "_Tuple2":
            return function () {
                 var score = renderScore(g.score);
                 var text = function () {
                    var _v71 = g.state;
                    switch (_v71.ctor)
                    {case "Over":
                       return _L.fromArray([A3(renderText,
                                           70,
                                           4,
                                           "Game Over")
                                           ,score
   ...
   var input = function () {
      var windowCenter = A2($Signal._op["<~"],
      center,
      $Window.dimensions);
      var mouse = A2($Signal._op["~"],
      A2($Signal._op["<~"],
      relativeMouse,
      windowCenter),
      $Mouse.position);
      var time = A2($Signal._op["<~"],
      $Time.inSeconds,
      $Time.fps(30));
   ...
   var stepGame = F2(function (e,
   g) {
      return function () {
         var _v73 = g.state;
         switch (_v73.ctor)
         {case "Play":
            return A2(stepGamePlay,e,g);}
         return A2(playOnClick,e,g);
      }();
   });
   var main = function () {
